...
public class App {
	...
	public static void main(String[] args) {
		...
		Produit produit1=new Produit("ciseaux", new Papeterie("maped","kikoupefort",PapeterieCategorie.Autre), "rouge", 4, 5.5f, 5, "55","", revendeur1);
		Produit produit2=new Produit("chaise", new EquipementBureau("Ikea","JKLÜSTROSCH",BureauCategorie.ChaiseDeBureau), "grande avec accoudoirs", 100, 100f, 100, "56","", revendeur1);
		Produit produit3=new Produit("souris", new MaterielInformatique("Logitech","kisallume",LocalDate.of(2020,1,1),InfoCategorie.Souris), "usb", 10, 10.99f, 10, "57","", revendeur2);
		Produit produit4=new Produit("Calcul 1", new Livres("9783140464079","Antoine de Saint-Exupéry","Lulu Press","Roman",LocalDate.of(1943, 4, 6),"2","3"), "en bon etat", 1, 50f, 50, "58","", revendeur3);
		Produit produit5=new Produit("Guide etude chimie 3", new Ressource("53829103725415","Jean Chimiste","Chimiste pour la vie",TypeRessource.Electronique,"3"), "20 pages", 80, 9.99f, 9, "59","", revendeur5);
