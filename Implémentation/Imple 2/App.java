...
public class App {
	...
	public static void main(String[] args) {
		...
		produit1.setRevendeur(revendeur1);
		produit2.setRevendeur(revendeur2);
		produit3.setRevendeur(revendeur3);
		produit4.setRevendeur(revendeur4);
		produit5.setRevendeur(revendeur5);
		...
		Commande commande6 =new Commande(produits, acheteur1,acheteur1.getAdresse(), acheteur1.getTelephone(), carte1, menu1.systemeGeneral.creerID(), "non");

		acheteur1.addCommande(commande1);
		acheteur1.addCommande(commande6);
